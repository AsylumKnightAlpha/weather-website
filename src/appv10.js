...
const port = process.env.PORT || 3000 //**2a.**tells Heroku to listen to the correct port // enviornment variable value
...
app.get('/weather', (req, res) => { //route connection
    ...
    else {//callback chaining - geocode and then forecast //ADDED default as {} to valid parameter for non real value cases to avoid crash// in this case symbols !+-/
...
// Section 8 video 56 - Error Handling for Destructuring Obj: Capturing non-valid inputs using ES6 "default parameter value"
...
app.listen(port, () => { //**2b.**environment variable used by Heroku
    console.log('Sever is up on port port ' + port)
}) 
